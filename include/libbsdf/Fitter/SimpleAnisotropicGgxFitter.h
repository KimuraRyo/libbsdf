...
#ifndef LIBBSDF_SIMPLE_ANISOTROPIC_GGX_FITTER_H
#define LIBBSDF_SIMPLE_ANISOTROPIC_GGX_FITTER_H
...
/*!
 * \class   SimpleAnisotropicGgxFitter
 * \brief   The SimpleAnisotropicGgxFitter class provides functions to fit the parameters of the anisotropic GGX reflectance model to BRDF.
 */
class SimpleAnisotropicGgxFitter : public BrdfFitter
{
public:
    /*!
     ...
     */
    static SimpleAnisotropicGgx
    estimateParameters(const Brdf&         brdf,
     ...
     * \param maxTheta      Maximum incoming and outgoing polar angle of sample points for fitting.
     */
    static void estimateParameters(SimpleAnisotropicGgx* model,
                                   const Brdf&           brdf,
                                   int                   numSampling = 100000,
                                   const Vec3::Scalar&   maxTheta = Vec3::Scalar(PI_2_D));
};
...
#endif // LIBBSDF_SIMPLE_ANISOTROPIC_GGX_FITTER_H
